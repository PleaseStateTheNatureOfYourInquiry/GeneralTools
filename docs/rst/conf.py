...
import sys, os
sys.path.append ( os.path.abspath ('/Users/maarten/Science/PythonRoutines/GeneralTools/DataTools') )
sys.path.append ( os.path.abspath ('/Users/maarten/Science/PythonRoutines/GeneralTools/HandyTools') )



# -- Project information -----------------------------------------------------

project = 'GeneralTools Documentation'
