...
class HandyTools:
    ...
    def getNotchFilteredSignal (inputSignal, samplingFrequency = 1000, notchFrequency = 50, qualityFactor = 20):
        ...
        return DataTools.getNotchFilteredSignal (inputSignal, samplingFrequency = 1000, notchFrequency = 50, qualityFactor = 20)
    ...
    def linearLeastSquare (xInput, yInput):
        ...
        **Description:**
        ...
        return DataTools.linearLeastSquare (xInput, yInput) 
    ...
    def getCumulativeNormalDistribution (mu,sigma):
        ...
        **Description:**
        ...
        return DataTools.getCumulativeNormalDistribution (mu,sigma)
    ...
    def getNormalDistribution (mu,sigma):
        ...
        **Description:**
        ...
        return DataTools.getNormalDistribution (mu,sigma)
    ...
    def getNormalDistributionValue (xi,mu,sigma):
        ...
        **Description:**
        ...
        return DataTools.getNormalDistributionValue (xi,mu,sigma)
